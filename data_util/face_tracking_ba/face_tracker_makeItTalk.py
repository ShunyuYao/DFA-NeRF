...
# lms = load_dir(os.path.join(id_dir, 'ori_imgs'), start_id, end_id)
save_dir = '/media/Diskf/projects/ADNerf/dataset/obama/makeItTalk_generate_exp.pt'
...
torch.save({'id': id_para.detach().cpu(), 'exp': exp_para.detach().cpu(),
            ...
            'focal': focal_length.detach().cpu()}, save_dir)
