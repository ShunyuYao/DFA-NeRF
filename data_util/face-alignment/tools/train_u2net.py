...
from core.function import train_face_u2net
from core.function import validate_face_u2net
...
from models.face_u2net import U2NET, U2NETP_S5
...
def main():
    ...
    model = U2NET(out_ch=cfg.MODEL.NUM_FACE_JOINTS)
    # eval('models.'+cfg.MODEL.NAME+'.get_face_net')(
    #     cfg, is_train=True
    # )
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        train_loss = train_face_u2net(cfg, train_loader, model, criterion, optimizer, epoch,
                                      final_output_dir, tb_log_dir, writer_dict)

        # evaluate on validation set
        perf_indicator, test_loss = validate_face_u2net(
