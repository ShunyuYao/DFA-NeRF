...
from core.loss_dense import FocalLoss
from core.function import train_center_face
from core.function import validate_center_face
...
def main():
    ...
    elif cfg.LOSS.CRITERION_HEATMAP == 'focal':
        criterion['heatmap'] = FocalLoss().cuda()
    else:
        raise Exception('The criterion not implemented.')
    # Data loading code
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        train_center_face(cfg, train_loader, model, criterion, optimizer, epoch,
                   final_output_dir, tb_log_dir, writer_dict)

        # evaluate on validation set
        perf_indicator = validate_center_face(
