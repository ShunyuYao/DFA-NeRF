...
from core.function import train_eye
from core.function import validate_eye
...
def main():
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        train_loss = train_eye(cfg, train_loader, model, criterion, optimizer, epoch,
                               final_output_dir, tb_log_dir, writer_dict)

        # evaluate on validation set
        perf_indicator, test_loss = validate_eye(
