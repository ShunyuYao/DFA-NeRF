...
# pose_resnet related params
FACE_MOBILENET = CN()
FACE_MOBILENET.INTERMEDIATE_CHANNELS = 640
FACE_MOBILENET.DOWN_SAMPLE = 32
FACE_MOBILENET.USE_REGRESS_BRANCH = True
FACE_MOBILENET.USE_HEATMAP_BRANCH = False
FACE_MOBILENET.USE_AUX_HEAD = False

EYE_GHOSTNET = CN()
EYE_GHOSTNET.ADDITION_ENCODER_LAYER = 0
EYE_GHOSTNET.ADDITION_DECODER_LAYER = False
# FACE_MOBILENET.DECONV_WITH_BIAS = False
# FACE_MOBILENET.NUM_DECONV_LAYERS = 3
# FACE_MOBILENET.NUM_DECONV_FILTERS = [256, 256, 256]
# FACE_MOBILENET.NUM_DECONV_KERNELS = [4, 4, 4]
# FACE_MOBILENET.FINAL_CONV_KERNEL = 1
# FACE_MOBILENET.PRETRAINED_LAYERS = ['*']

MODEL_EXTRAS = {
    'pose_resnet': POSE_RESNET,
    'pose_high_resolution_net': POSE_HIGH_RESOLUTION_NET,
    'face_mobilenet': FACE_MOBILENET,
    'eye_ghostnet': EYE_GHOSTNET
}
