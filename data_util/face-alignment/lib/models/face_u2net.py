...
class U2NET(nn.Module):
    ...
    def forward(self,x):
        ...
        return d0, d2, d3, d4, d5, d6
        # return F.sigmoid(d0), F.sigmoid(d1), F.sigmoid(d2), F.sigmoid(d3), F.sigmoid(d4), F.sigmoid(d5), F.sigmoid(d6)

### U^2-Net small ###
class U2NETP_S5(nn.Module):

    def __init__(self,in_ch=3,out_ch=1):
        super(U2NETP_S5, self).__init__()

        self.stage1 = RSU6(in_ch,16,64)
        self.pool12 = nn.MaxPool2d(2,stride=2,ceil_mode=True)

        self.stage2 = RSU5(64,16,64)
        self.pool23 = nn.MaxPool2d(2,stride=2,ceil_mode=True)
        ...
        self.stage2d = RSU5(128,16,64)
        self.stage1d = RSU6(128,16,64)
        ...
        self.outconv = nn.Conv2d(out_ch*5,out_ch,1)
...
### U^2-Net small ###
class U2NET_tiny(nn.Module):

    def __init__(self,in_ch=3,out_ch=1):
        super(U2NET_tiny, self).__init__()
