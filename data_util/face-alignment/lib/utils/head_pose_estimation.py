...
class PoseEstimator:
    ...
    def _get_full_model_points(self, filename='./lib/utils/head_pose_model.txt'):  # filename='assets/model.txt'):
    ...
    def translate_vec_to_angle(self, vecs):
        r_vec = vecs[0]
        t_vec = vecs[1]
    ...
    def draw_axes(self, img, R, t):
        img	= cv2.drawFrameAxes(img, self.camera_matrix, self.dist_coeefs, R, t, 100)
